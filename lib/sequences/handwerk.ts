...
<p>Wenn Sie sehen möchten, wie das konkret funktioniert — lassen Sie uns 30 Minuten sprechen:<br>
...
{{FOOTER}}
  ...
  },
  {
    ...
    dayOffset: 3,
    channel: 'email',
    subject: '45 Minuten → 7 Minuten: Was ein Elektrobetrieb automatisiert hat',
    bodyTemplate: `<html>
<body style="font-family: Arial, sans-serif; font-size: 15px; color: #333; line-height: 1.6;">
<p>Hallo {{first_name}},</p>
...
<p>Könnte so etwas auch für {{company_name}} funktionieren?<br>
...
<p>Klingt das relevant für Sie?<br>
<a href="https://calendly.com/meyer-samantha-praxisnovaai/30min">Termin buchen</a></p>
