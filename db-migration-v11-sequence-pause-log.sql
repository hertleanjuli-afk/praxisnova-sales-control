-- Migration v11: sequence_pause_log + ICP-Switch Bau/Handwerk-Pause
-- Track 3, T3.1, 2026-04-21
-- Vorher: Track 1 v9 (linkedin_state + blocks) + v10 (dashboard indexes).
-- Nachher: Track 3 v12 (icp_score + icp_config).
--
-- Zweck:
...
--     FROM sequence_pause_log WHERE operator = 'track-3-migration-v11' GROUP BY 1;
...
--       AND id IN (SELECT lead_id FROM sequence_pause_log WHERE operator = 'track-3-migration-v11');
--   DELETE FROM sequence_pause_log WHERE operator = 'track-3-migration-v11';
