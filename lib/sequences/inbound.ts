...
{{FOOTER}}`
  ...
  { step: 2, dayOffset: 1, channel: 'email',
    subject: 'Erinnerung: Bitte best\u00e4tigen Sie Ihre Anmeldung',
    bodyTemplate: `<p>{{SALUTATION}},</p>
<p>wir haben gestern eine Best&auml;tigungsmail an Sie gesendet. Falls Sie diese &uuml;bersehen haben: Bitte klicken Sie auf den folgenden Link, um Ihre Anmeldung abzuschlie&szlig;en.</p>
<p><a href="{{OPT_IN_LINK}}">Jetzt E-Mail-Adresse best&auml;tigen</a></p>
...
{{FOOTER}}`
  ...
  { step: 3, dayOffset: 0, channel: 'email',
...
{{FOOTER}}`
  ...
  { step: 4, dayOffset: 7, channel: 'email',
    subject: 'Wie Unternehmen mit KI Zeit und Geld sparen',
    bodyTemplate: `<p>{{SALUTATION}},</p>
<p>wussten Sie, dass viele unserer Kunden bereits nach wenigen Wochen sp&uuml;rbare Ergebnisse sehen? Ein mittelst&auml;ndisches Unternehmen hat mit unserer Hilfe 15&nbsp;Stunden pro Woche an manueller Arbeit eingespart.</p>
<p>Der erste Schritt war unser <strong>KI-Quickcheck</strong>: Ein kompakter 2-Stunden-Audit, bei dem wir gemeinsam Ihre Prozesse analysieren und die drei gr&ouml;&szlig;ten Automatisierungshebel identifizieren.</p>
...
{{FOOTER}}`
  ...
  { step: 5, dayOffset: 14, channel: 'email',
...
<p>Falls Sie unsicher sind, wo Sie anfangen sollen: Genau daf&uuml;r gibt es unseren KI-Quickcheck. In 2&nbsp;Stunden bekommen Sie Klarheit &uuml;ber Ihre wichtigsten Automatisierungspotenziale.</p>
